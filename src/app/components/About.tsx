  ...
  return (
    <SectionContainer id="about" title="About me">
      <div className="flex items-center justify-between md:justify-center">
        ...
        >
          <p>
            I am a Master of Engineering student with a strong foundation in Web Development, React.js, Node.js, Frontend Development, and Cloud Computing. I have a keen eye for UI/UX, Figma design and enjoy crafting intuitive, user-friendly experiences.
          </p>

          <p>
            Proficient in C and C++, Passionate about technology and innovation, I actively seek opportunities to learn, contribute, and stay ahead in the ever-evolving tech era.
          </p>
